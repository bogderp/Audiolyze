...
<body>
    ...
    <p id="collection" style="display:none">Click to Start</p>
    <p id="grantPerm" style="display:none">You need to grant permissions first, 
        Please allow access to use Spotigraph!</p>
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    ...
                                    document.getElementById('playstat').innerHTML = 
                                        ("Top Five Artists' Number of Plays (Out of 3000)"+ '<br>' + 
